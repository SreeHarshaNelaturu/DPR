...
lighting_choices = category(choices=["left", "top_left", "top", "top_right", "right",
                                    "bottom", "bottom_left", "custom"])

inputs = {"input_image" : image, "lighting_choice" : lighting_choices, "param0" : number, "param1" : number, "param2" : number, "param3" : number,
          "param4" : number, "param5" : number, "param6" : number, "param7" : number, "param8" : number}
outputs = {"output_image" : image}


@runway.command("relight_image", inputs=inputs, outputs=outputs, description="Relight Images")
